    ...
    <div className="mb-[18px] grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-3">
      {top3.map((p) => {
        ...
        return (
          ...
          >
            <div className="font-mono text-[10px] tracking-[0.16em] text-muted">#{p.rank}</div>
            <span
            ...
            />
            <div className="font-mono text-[9.5px] tracking-[0.12em] text-gold-bright">{TIER_LABEL[p.tier]}</div>
            ...
            <div className="font-mono text-[15px] text-text">{p.name}</div>
